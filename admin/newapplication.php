			...
			<div class="col-md-8 mx-auto">
				...
				<form class="row g-3" action="counsler/redirect/applications/add.php">
					...
					<div class="col-12">
                        <div class="row g-xl-0 align-items-center">
                            <div class="col-lg-4">
                                <h6 class="mb-lg-0">Select Counsler <span class="text-danger">*</span></h6>
                            </div>
                            <div class="col-lg-8">
                                <select class="form-control" id="collegeId" name="cid">
                                    <option value="">Select Counsler</option>
									<?php
										$rows = $usersRepo->fetchby("role like 'counsler'");
										foreach($rows as $row){
