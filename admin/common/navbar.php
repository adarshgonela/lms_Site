	...
	<div class="offcanvas offcanvas-start flex-row custom-scrollbar h-100" data-bs-backdrop="true" tabindex="-1" id="offcanvasSidebar">
		<div class="offcanvas-body sidebar-content d-flex flex-column bg-dark">
			...
			<ul class="navbar-nav flex-column" id="navbar-sidebar">
				...
				<!-- Menu item 1 -->
				<li class="nav-item"><a href="admin/dashboard.php" class="nav-link <?php echo $current_file=='dashboard'? 'active' :'' ;?>"><i class="bi bi-house fa-fw me-2"></i>Dashboard</a></li>
				
				<!-- Menu item 2 -->
				<li class="nav-item"> <a class="nav-link <?php echo $current_file=='counslers'? 'active' :'' ;?>" href="admin/counslers.php"><i class="fas fa-user-tie fa-fw me-2"></i>Counslers</a></li>


				<!-- Menu item 3 -->
				<li class="nav-item"> <a class="nav-link <?php echo $current_file=='students'? 'active' :'' ;?>" href="admin/students.php"><i class="fas fa-user-graduate fa-fw me-2"></i>Students</a></li>
				...
				<li class="nav-item"><a class="nav-link text-danger" href="admin/redirect/auth/logout.php"><i class="fas fa-sign-out-alt fa-fw me-2"></i>Sign Out</a></li>
