...
<!-- Mirrored from eduport.webestica.com/admin-student-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 29 May 2024 09:09:08 GMT -->
<head>
					...
					<div class="tab-pane fade show active" id="nav-preview-tab-1">
						<div class="row g-4">
                            ...
                            if(isset($_REQUEST['search'])){
                                ...
                                $students = $usersRepo->fetchby("`role` Like 'student' AND (name LIKE '%$search%')");
                            }
                            else{
                                $students = $usersRepo->fetchby("`role` Like 'student'");
                            }
									...
									<div class="card-body">
										...
										<div class="d-flex justify-content-between align-items-center mb-3">
											<div class="d-flex align-items-center">
												<div class="icon-md bg-info bg-opacity-10 text-success rounded-circle flex-shrink-0"><i class="fas fa-user-tie fa-fw"></i></div>
												<h6 class="mb-0 ms-2 fw-light">Counsler</h6>
											</div>
											<span class="mb-0 fw-bold"><?php echo $studentcounsler ?></span>
										</div>
									...
									<div class="card-footer bg-transparent border-top">
										<div class="d-sm-flex justify-content-between align-items-center">
											...
											<h6 class="mb-2 mb-sm-0">
												<i class="bi bi-calendar fa-fw text-orange me-2"></i><span class="text-body">Join at:</span> <?php echo $EnrolledDate ?>
											</h6>
											<!-- Buttons -->
								...
								<tbody>
									...
									<tr>
										...
										<td>
											<div class="d-flex align-items-center position-relative">
												...
												<div class="mb-0 ms-3">
													...
													<span class="text-body small"><i class="fas fa-fw fa-map-marker-alt me-1 mt-1"></i><?php echo $studentEmail ?></span>
												</div>
											</div>
										</td>
										...
										<td class="text-center text-sm-start">
											<div class="overflow-hidden">
												<h6 class="mb-0"><?php echo $studentcounsler ?></h6>
												<!--<div class="progress progress-sm bg-primary bg-opacity-10">-->
												<!--	<div class="progress-bar bg-primary aos" role="progressbar" data-aos="slide-right" data-aos-delay="200" data-aos-duration="1000" data-aos-easing="ease-in-out" style="width: 100%" aria-valuenow="85" aria-valuemin="0" aria-valuemax="100">-->
												<!--	</div>-->
												<!--</div>-->
											</div>
										</td>
										...
										<!-- Table data -->
										<td>
											<a target="_blank" href="admin/student.php?student=<?php echo $studentEmail ?>" class="btn btn-light btn-round me-1 mb-1 mb-md-0" data-bs-toggle="tooltip" data-bs-placement="top" title="View">
												<i class="bi bi-eye"></i>
											</a>
